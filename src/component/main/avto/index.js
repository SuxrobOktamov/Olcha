...
function Avto() {
    ...
    const Data = Datas.items.slice(35, 40);
    ...
    <>
      <section className='popular books'>
        <div className='popular__container '>
            ...
            <div className="catalog-offers__widget">
                <Link to="#"><img src="https://olcha.uz/image/272x444/homePage/sXucmM8gqWHhDeSWbBziBP8eXIwnfRkQf5Tx8T4BX9txupgGivXYhiomzrlz.png" alt='' /></Link>
            </div>
        ...
        <div className="offer__container">
            <div className="offer__bottom-row">
                <Link to='#' className="offer__item">
                    <img src="https://olcha.uz/image/original/homePage/H8MlOeMRwNCKCEMNfz3COnFxnJhixSDTyot8J7DyfaC9nUs7boRQHPx7nuqb.png" alt='' />
                </Link>
                <Link to='#' className="offer__item" >
                    <img src="https://olcha.uz/image/original/homePage/g8aDqY6Ht4O9Qo1l98aEBW9q8Rl5PL5e96WVXoKriBM6bq2SOtAUw5XcelSY.png" alt='' />
                </Link>
            </div>
        </div>
      </section>
