...
function Books() {
    ...
    const Data = Datas.items.slice(30, 35);
    ...
    <section className='popular books'>
        <div className='popular__container '>
            ...
            <div className="catalog-offers__widget">
                <Link to="#"><img src="https://olcha.uz/image/272x444/homePage/L7glHAPUJiC9RB15XAdDq52DinD9ZyeQXBp3XvIsUs9OBOObMv8CVzOaEqHV.png" alt='' /></Link>
            </div>
